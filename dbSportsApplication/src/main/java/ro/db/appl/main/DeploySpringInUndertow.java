...
import ro.db.appl.config.web.server.ContextLoaderListenerInstanceFactory;
import ro.db.appl.config.web.server.DispatcherServletInstanceFactory;
...
public class DeploySpringInUndertow {
    ...
    private void configureUndertow() throws ServletException {
        ...
        server = Undertow.builder().addHttpListener(8081, "localhost")
    ...
    private static final String CONTEXT_PATH = "/dbSports-app";
    private static final String PKG_NAME = "dbSports-app.war";
